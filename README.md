...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xlh4ju.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xlh4ju.containers.anotherwebservice.com/
...
```
git clone git@github.com:Solo120140/container-xlh4ju.git
cd container-xlh4ju
```
...
```
docker attach container-xlh4ju
```
